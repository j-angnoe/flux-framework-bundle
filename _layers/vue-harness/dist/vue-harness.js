...
},{}],"node_modules/vue-blocks/vue-component-framework.js":[function(require,module,exports) {
var process = require("process");
...
},{"process":"node_modules/process/browser.js"}],"node_modules/vue-blocks/index.js":[function(require,module,exports) {
"use strict";
...
var _vueComponentFramework = _interopRequireDefault(require("./vue-component-framework"));
 ...
 * 
 */
_vueComponentFramework.default.install = function (Vue, options) {
  // set default options
  options = {
    async: true,
  ...
  _vueComponentFramework.default.setRegistrar(Vue.component.bind(Vue));

  _vueComponentFramework.default.loadModules();

  var promise = _vueComponentFramework.default.loadVueComponents(); // This is necessary for resolving template[src] stuff.
  ...
  if (options.async) {
    ...
    Vue.prototype.$mount = function (...args) {
      ...
      if (options.registerRoutes) {
        if (self.$router) {
          self.$router.addRoutes(_vueComponentFramework.default.collectRoutes());
        }
      }
...
window.VueBlocks = _vueComponentFramework.default;
var _default = _vueComponentFramework.default;
exports.default = _default;
},{"./vue-component-framework":"node_modules/vue-blocks/vue-component-framework.js"}],"node_modules/vue-router/dist/vue-router.esm.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{}],"components/ui-suggest.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  computed: {
    ...
    primaryKeyField: function primaryKeyField() {
      return this.options && this.options.primaryKey || 'id';
    },
    displayField: function displayField() {
  ...
  mounted: function mounted() {
    ...
    if (this.value && typeof this.value == 'String') {
      this.search = this.value; // prevent the suggestions from popping up.
  ...
  methods: {
    ...
    tleSearch: function tleSearch() {
      var _this3 = this;

      clearTimeout(this.timeout);
      this.timeout = setTimeout(function () {
        _this3.performSearch(_this3.search);
      }, 160);
    },
    ...
    displayItem: function displayItem(item) {
    ...
    getTermScoreFor: function getTermScoreFor(searchable, term) {
      var score = 0; // ensure both arguments are strings.
    ...
    _getMatches: function _getMatches(items, term) {
      var _this4 = this;
      ...
      return items.map(function (key) {
        ...
        if (_typeof(key) == 'object') {
          var score1 = _this4.getTermScoreFor(_this4.displayItem(key), term);

          var score2 = _this4.getTermScoreFor(Object.values(key).join(','), term);

          score = score1 * 10 + score2;
        } else {
          score = _this4.getTermScoreFor(key, term);
        }
    ...
    performSearch: function () {
      var _performSearch = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime().mark(function _callee(term) {
        var _this5 = this;

        var currentSearch, suggestions;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                currentSearch = ++this.searchIndex;
                this.searching = true;

                if (typeof this.call === 'function') {
                  this.searchPromise = Promise.resolve(this.call(term));
                } else if (typeof this.call === 'string') {
                  this.searchPromise = eval('api.' + this.call)(term, {
                    exclude: [].concat(this.selectedItems).map(function (item) {
                      return item[_this5.primaryKey];
                    })
                  });
                } else if (this.items) {
                  this.searchPromise = Promise.resolve(this.items).then(function (items) {
                    return _this5._getMatches(items, term);
                  }).then(function (items) {
                    return items.map(function (item) {
                      if (_typeof(item) != 'object') {
                        ...
                        obj[_this5.primaryKeyField] = item;
                        obj.__resolve = item;
                        return obj;
                      }
              ...
              case 11:
                ...
                this.suggestions = _toConsumableArray(suggestions);
    ...
    remove: function remove(item) {
      if (this.multiMode) {
        return this.$emit('input', this.selectedItems.filter(function (i) {
          return i !== item;
        }));
      } else {
    ...
    select: function select(item) {
      ...
      if (this.multiMode) {
        emitValue = [].concat(_toConsumableArray(this.value), [item]);
      } else {
        emitValue = item;
      }
    ...
    selectFirst: function selectFirst() {
      ...
      alert("Selectfirst?"); // warning: This function may be overwritten if initKeydownhandler is called.

      if (this.searchPromise) {
        this.searchPromise.then(function (x) {
          alert("Deze?");

          if (_this6.suggestions.length > 0) {
            alert(_this6.suggestions.length);

            _this6.select(_this6.suggestions[0]);
          } else if (_this6.$listeners['create']) {
            _this6.$emit('create', _this6.search);
          }
        });
      }
    },
    enableUpDownSelect: function enableUpDownSelect() {
      var _this7 = this;

      var selectedIndex = 0;

      var selectOption = function selectOption(index) {
        if (!_this7.$refs.suggestionsContainer) {
          return;
        }

        var selected = _this7.$refs.suggestionsContainer.querySelector('.selected');

        if (selected) {
          selected.classList.remove('selected');
        }

        selectedIndex = (index + Math.max(1, _this7.suggestions.length)) % Math.max(1, _this7.suggestions.length);

        if (_this7.suggestions.length > 0) {
          _this7.$refs.suggestionsContainer.childNodes[selectedIndex].classList.add('selected');
        }
      ...
      this.selectFirst = function () {
        if (_this7.suggestions.length > 0) {
          _this7.select(_this7.suggestions[selectedIndex]);
        } else if (_this7.$listeners['create']) {
          _this7.$emit('create', _this7.search);
        }
      }; // When suggestions are renewed we need to redraw
      // the highlighted option.


      this.updatedSuggestions = function () {
        // Timing: Just after DOM has updated.
        setTimeout(function () {
          return selectOption(selectedIndex);
        }, 25);
      };

      this.$refs.search.addEventListener("keydown", function (event) {
        var isPrevious = event.key === 'ArrowUp' || _this7.options.selectLeftRight && event.key == 'ArrowLeft';
        var isNext = event.key === 'ArrowDown' || _this7.options.selectLeftRight && event.key === 'ArrowRight';
    ...
    potentiallyLoseFocus: function potentiallyLoseFocus() {
      var _this8 = this;

      setTimeout(function () {
        _this8.focussed = false;
      }, 200);
    }
  }
};
exports.default = _default;
        var $8533db = exports.default || module.exports;
      
      if (typeof $8533db === 'function') {
        $8533db = $8533db.options;
      }
    
        /* template */
        Object.assign($8533db, (function () {
          var render = function () {
  var _vm = this
  ...
  return _c(
    "span",
    {
      staticClass: "ui-suggest",
      class: { selected: _vm.selectedItems.length > 0 },
      on: {
    ...
    [
      ...
      _vm._v(" "),
      _c("span", { staticClass: "ui-suggest-cursor" }, [
        _c("input", {
          ref: "search",
          attrs: { placeholder: _vm.$attrs.placeholder },
          domProps: { value: _vm.displayItem(_vm.search) },
          on: {
            ...
            focus: function ($event) {
              _vm.value && _vm.$refs.search.select()
              _vm.focussed = true
            },
            ...
            blur: function ($event) {
              return _vm.potentiallyLoseFocus()
            },
          },
        }),
        _vm._v(" "),
        _vm.search && _vm.focussed && (_vm.searching || _vm.suggestions)
          ? _c("div", { staticClass: "suggestions" }, [
              _vm.searching ? _c("div", [_vm._v("Searching...")]) : _vm._e(),
              _vm._v(" "),
              _vm.search.length > 0 && !_vm.searching && _vm.suggestions
                ? _c("div", [
                    _vm.suggestions.length === 0
                      ? _c("div", [
                          _vm.$listeners["create"]
                            ? _c("div", [
                                _vm._v(
                                  "\n                    Add `" +
                                    _vm._s(_vm.search) +
                      ...
                      : _c(
                          "ul",
                          { ref: "suggestionsContainer", class: _vm.listclass },
...
render._withStripped = true
          ...
          return {
            ...
            _compiled: true,
            _scopeId: "data-v-8533db",
            functional: undefined
          };
        })());
      
},{}],"components/provide-suggestions.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 8:
              this.search = _toConsumableArray(this.$el.querySelectorAll('input')).pop();
              console.log('Provide-suggestions using search ', this.search);

            case 10:
              w = this.$attrs.width || this.search.offsetWidth;
              ...
              _toConsumableArray(this.$el.querySelectorAll('input,textarea')).forEach(function (search) {
                search.addEventListener('input', function (event) {
                  if (_this2.focus) {
                    _this2.performSearchDebounced(event.target.value);
                  }
                });
                ...
                search.addEventListener('keydown', function (event) {
                  ...
                  var doSelectValue = event.key == 'Enter' || event.key === 'Tab'; // if (this.$attrs.separator) { 
                  //     doSelectValue = doSelectValue || event.key.match(this.$attrs.separator);
                  // }

                  if (doSelectValue) {
                    if (_this2.lastResolved === _this2.suggestions[_this2.selectedIndex]) {
                      _this2.suggestions = null;
                      return;
                    } else if (_this2.suggestions) {
                      _this2.lastResolved = _this2.suggestions[_this2.selectedIndex];

                      _this2.resolve(_this2.suggestions[_this2.selectedIndex]);

                      event.preventDefault();
                    }

                    if (event.ctrlKey || event.metaKey || event.key === 'Tab') {
                      event.preventDefault(); // Als je ctrl+enter doet dan sluiten we de
                  ...
                  if (event.key.match(/(ArrowUp|ArrowDown)/)) {
                    ...
                    if (_this2.suggestions) {
                      _this2.selectedIndex += event.key == 'ArrowUp' ? -1 : 1;
                      _this2.selectedIndex += _this2.suggestions.length;
                      _this2.selectedIndex %= _this2.suggestions.length;
                    }
                  }
                });
              ...
              this.$refs.sc.addEventListener('mousedown', function (event) {
                setTimeout(function () {
                  clearTimeout(blurTimeout);
                }, 10);
              });
              ...
              if (this.$attrs['display-value']) {
                ...
                this.performSearch(this.$attrs['value'], function (results) {
                  if (~results.indexOf(_this2.$attrs['value'])) {
                    results = [_this2.$attrs['value']];
                  }

                  if (results && results[0]) {
                    _this2.search.value = _this2.displayItem(results[0]);
                  }
                });
              }
  ...
  methods: {
    ...
    resolve: function resolve(value) {
      ...
      if (value) {
        this.$emit('select', value); // If multi mode, re-focus on search.
        ...
        this.search.blur(); // alert("VALUE in attrs");
    ...
    performSearch: function () {
      var _performSearch = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime().mark(function _callee2(term, callback) {
        var _this3 = this;

        var call, suggestions;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                call = this.$attrs.call || this.$attrs.from || null;
                this.loading = true;
                ...
                if (typeof call === 'function') {
                  ...
                  this.searchPromise = Promise.resolve(this.$attrs.items).then(function (items) {
                    return _this3._getMatches(items, term);
                  }).then(function (items) {
                    return items.map(function (item) {
                      return item;
                    });
                ...
                this.searchPromise.finally(function () {
      ...
      function performSearch(_x, _x2) {
        return _performSearch.apply(this, arguments);
      }

      return performSearch;
    }(),
    performSearchDebounced: function performSearchDebounced(term) {
      var _this4 = this;
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                return _context3.abrupt("return", _this4.performSearch(term));
    ...
    _getMatches: function _getMatches(items, term) {
      ...
      return items.map(function (key) {
        ...
        if (_typeof(key) == 'object') {
          var score1 = _this5.getTermScoreFor(_this5.displayItem(key), term);

          var score2 = _this5.getTermScoreFor(Object.values(key).join(','), term);

          score = score1 * 10 + score2;
        } else {
          score = _this5.getTermScoreFor(key, term);
        }
...
exports.default = _default;
        var $e4f862 = exports.default || module.exports;
      
      if (typeof $e4f862 === 'function') {
        $e4f862 = $e4f862.options;
      }
    
        /* template */
        Object.assign($e4f862, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
    ...
    [
      !("target" in _vm.$attrs)
        ? _vm._t("default", function () {
            return [_c("input", { attrs: { type: "search" } })]
          })
        : _vm._e(),
      _vm._v(" "),
      _c(
        ...
        {
          ref: "sc",
          staticClass: "suggestions-container",
          style: {
            display:
              (_vm.focus && _vm.suggestions) || _vm.scDisplay
                ? "block"
                : "none",
            opacity: _vm.focus && _vm.suggestions ? 1 : 0,
          },
        },
        [
          _c(
          ...
          "table" in _vm.$attrs
            ? _c(
                ...
                _vm._l(_vm.suggestions, function (s, index) {
                  return _c(
                    "tr",
                    {
                      class: {
                        suggestion: true,
                        highlight: index == _vm.selectedIndex,
                      },
                      on: {
                        click: function ($event) {
                          return _vm.resolve(s)
                        },
                      },
                    },
                    [
...
var staticRenderFns = [
  function () {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("li", { staticClass: "loading" }, [
...
render._withStripped = true
          ...
          return {
            ...
            staticRenderFns: staticRenderFns,
            _compiled: true,
            _scopeId: "data-v-e4f862",
            functional: undefined
          };
        })());
      
},{}],"components/toast/index.js":[function(require,module,exports) {
  ...
  methods: {
    ...
    add: function add(message) {
      ...
      if (true || !originalMessage.length) {
        ...
        message = _objectSpread(_objectSpread({}, originalMessage[0]), message);
      }
...
module.exports.exposeAs = function (toastName) {
  toastName = 'toast'; // extend our global app.
...
},{}],"components/dialog/index.js":[function(require,module,exports) {
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
function launchDialog() {
  var data = makeDialogOptions.apply(void 0, arguments); // `on` is an alias for `listeners`.

  data.listeners = _objectSpread(_objectSpread(_objectSpread({}, data.listeners || {}), data.on || {}), data.connect ? {
...
Vue.component("flux-dialog", {
  ...
  computed: {
    styles: function styles() {
      ...
      var res = {};
      res.display = this.display; // console.log(this.$attrs);
      ...
      checkSupplied.map(function (attr) {
        if (attr in _this.$attrs) {
          console.log('set ' + attr + ' to ' + _this.$attrs[attr]);
          res[attr] = _this.$attrs[attr];
        }
      });
  ...
  methods: {
    init: function init() {
      ...
      if (main) {
        Object.entries(main.attributes).map(function (_ref) {
          var _ref2 = _slicedToArray(_ref, 2),
              key = _ref2[0],
              item = _ref2[1];

          if (item.nodeName in _this2.$data) {
            _this2[item.nodeName] = item.nodeValue;
      ...
      var mousemoveHandler = function mousemoveHandler(event) {
        if (operation) {
          ...
          if (operation.type == 'translate') {
            _this2.$el.style.left = window.pageXOffset + operation.left - vector.x + 'px';
            _this2.$el.style.top = window.pageYOffset + operation.top - vector.y + 'px';
          } else if (operation.type == 'resize') {
            _this2.$el.style.width = operation.width - vector.x + 'px';
            _this2.$el.style.height = operation.height - vector.y + 'px';
          }
        }
      };
      ...
      var mouseupHandler = function mouseupHandler(event) {
        ...
        if (operation) {
          clearMouseHandlers();
          _this2.$el.style.userSelect = '';
          _this2.$el.style.cursor = '';
          operation = null;
        }
      };

      var registerMouseHandlers = function registerMouseHandlers() {
        document.body.addEventListener('mousemove', mousemoveHandler);
        document.body.addEventListener('mouseup', mouseupHandler);
      };

      var clearMouseHandlers = function clearMouseHandlers() {
      ...
      this.$el.addEventListener('mousedown', function (event) {
        ...
        var bb = _this2.$el.getBoundingClientRect();
        ...
        if (operationType) {
          ...
          timeout = setTimeout(function () {
            ...
            _this2.$el.style.userSelect = 'none';
            _this2.$el.style.cursor = operationType == 'translate' ? 'move' : 'nw-resize';
            operation = {
              pageX: event.pageX,
              pageY: event.pageY,
              left: bb.left,
    ...
    captureInitialFocus: function captureInitialFocus() {
      ...
      setTimeout(function () {
        var firstInput = _this3.$el.querySelector("input,select,textarea");
    ...
    setInitialPosition: function () {
      var _setInitialPosition = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime().mark(function _callee2() {
        var width, height, box, overflow, offset;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
              ...
              case 7:
                ...
                box.top += window.pageYOffset; // requires mouse position to be stored locally.
      ...
      function setInitialPosition() {
        return _setInitialPosition.apply(this, arguments);
      }
    ...
    registerEscapeListener: function registerEscapeListener() {
      ...
      var listener = function listener(event) {
        if (event.which === 27 && _this4.closable && !event.defaultPrevented) {
      ...
      function isLastActiveFlux() {
        ...
        // le.
        var all = document.querySelectorAll(".dialog-container"); // @todo active...
    ...
    isLastActiveFlux: function isLastActiveFlux() {
      // either the last/active and/or closab
      // le.
      var all = document.querySelectorAll(".dialog-container"); // @todo active...
...
function makeDialogOptions(content, component) {
  ...
  if (content.overlay) {
    try {
      ...
      var bb = el.getBoundingClientRect(); // when bb.height exceeds doc height, probably do it fullscreen 
...
function launchDialogPromise() {
  var data = makeDialogOptions.apply(void 0, arguments);
  ...
  var fns = {
    resolve: function resolve() {
      if (false !== _resolve2.apply(void 0, arguments)) {
        promise.dialog.close();
      }
    },
    reject: function reject() {
      if (false !== _reject2.apply(void 0, arguments)) {
        promise.dialog.close();
      }
    }
  }; // Resolve/reject are supplied as functions via component props.

  data.params = _objectSpread(_objectSpread({}, fns), data.params || {}); // We set up listeners

  data.listeners = _objectSpread(_objectSpread({}, fns), data.listeners || {}); // Oldskool: We inject $resolve/$reject functions into the function.
  ...
  promise.dialog.$on('close', function () {
    return _reject2('user closed dialog');
  });
  return promise;
}
},{}],"node_modules/locutus/php/datetime/date.js":[function(require,module,exports) {
'use strict';
...
},{}],"node_modules/locutus/php/datetime/strtotime.js":[function(require,module,exports) {
'use strict';
...
},{}],"components/debug.vue":[function(require,module,exports) {
"use strict";
...
document.addEventListener('DOMContentLoaded', function (event) {
  Vue.prototype.debug = function () {
    ...
    dialog.dialog("<pre \n            xstyle=\"white-space: pre-wrap;\" \n            title=\"Debug\" \n            width=800 \n            height=800>{{data}}\n        </pre>", {
      data: {
        data: JSON.stringify(args, null, 3).replace(/\\n/g, "\n")
      }
    });
  };
});
...
exports.default = _default;
        var $1629af = exports.default || module.exports;
      
      if (typeof $1629af === 'function') {
        $1629af = $1629af.options;
      }
    
        /* template */
        Object.assign($1629af, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    "div",
    _vm._l(_vm.target, function (val, name) {
      return _c("pre", [_vm._v(_vm._s(name) + ": " + _vm._s(val))])
    }),
    0
  )
}
...
},{}],"components/tabbed-view.vue":[function(require,module,exports) {
"use strict";
...
//
var _default = {
  props: ['localStorage', 'sessionStorage', 'value'],
  data: function data() {
    return {
      activeTabTitle: null,
      tabs: null
  ...
  mounted: function mounted() {
    ...
    var isSelected = function isSelected(child) {
      if (isFirst) {
        isFirst = false;
        return true;
      }
    ...
    if (this.activeTabTitle) {
      isSelected = function isSelected(child) {
        return child.getAttribute('title') === _this.activeTabTitle || child.getAttribute('value') === _this.activeTabTitle;
      };
    }

    this.$refs.tabContainer.childNodes.forEach(function (child) {
      ...
      if (child && child.hasAttribute && child.hasAttribute('title')) {
        ...
        child.show = function () {
          ...
          if (child.hasAttribute('value')) {
            _this.$emit('input', child.getAttribute('value'));
          }

          _this.activeTabTitle = tabTitle;
        };
  ...
  methods: {
    hideAll: function hideAll() {
      ...
      Object.keys(this.tabs).map(function (key) {
        _this2.tabs[key].hide();
      });
    }
  }
};
exports.default = _default;
        var $ab13ca = exports.default || module.exports;
      
      if (typeof $ab13ca === 'function') {
        $ab13ca = $ab13ca.options;
      }
    
        /* template */
        Object.assign($ab13ca, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", [
    _c(
      ...
      _vm._l(_vm.tabs, function (t, name) {
        return _c(
          "a",
          {
            staticClass: "nav-link",
            class: { active: _vm.activeTabTitle == name },
            on: {
              click: function ($event) {
                _vm.hideAll()
                t.show()
    ...
    _c(
      "div",
      { ref: "tabContainer", staticClass: "active-tab-container" },
      [_vm._t("default")],
      2
    ),
  ])
...
},{}],"components/ui-toggle.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $d15f5f = exports.default || module.exports;
      
      if (typeof $d15f5f === 'function') {
        $d15f5f = $d15f5f.options;
      }
    
        /* template */
        Object.assign($d15f5f, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
...
},{}],"components/display-table.vue":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  watch: {
    '$attrs.headers': function $attrsHeaders(h) {
      this.calculateHeaders();
    },
    '$attrs.data': function $attrsData(data) {
      var _this = this;

      clearTimeout(this.dataWatcherTimeout);
      this.dataWatcherTimeout = setTimeout(function () {
        console.log('display-table watchers $attrs.data');
        _this.data = data.concat([]);

        if (_this.isTable) {
          _this.calculateHeaders();
  ...
  computed: {
    isTable: function isTable() {
      ...
      if (!Array.isArray(this.data)) {
        console.log('fail at 2, ' + _typeof(this.data));
        return false;
      }
    ...
    numFilters: function numFilters() {
  ...
  methods: {
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 10:
                _context.next = 12;
                return Promise.resolve(this.from);
    ...
    calculateHeaders: function calculateHeaders() {
      var calcHeaders = (this.data && this.data[0] && Object.keys(this.data[0]) || []).filter(function (k) {
      ...
      if (this.$attrs.headers) {
        ...
        headers = headers.filter(function (h) {
          ...
          if (h.substr(0, 1) === '-') {
            ...
            collectedHeaders = collectedHeaders.filter(function (c) {
              return c !== h.substr(1);
            });
            return false;
          }
        ...
        calcHeaders = _toConsumableArray(new Set([].concat(_toConsumableArray(headers), _toConsumableArray(collectedHeaders || []))));
      }
    ...
    orderData: function orderData() {
      ...
      try {
        if (Object.keys(this.rowFilters).length > 0) {
          var filters = Object.entries(this.rowFilters).map(function (_ref) {
            var _ref2 = _slicedToArray(_ref, 2),
                column = _ref2[0],
                value = _ref2[1];
          ...
          var filterFn = function filterFn(row) {
            var fn;
      ...
      try {
        var sorterFn = function sorterFn(a, b) {
          if (_this2.grid_reverse) {
            var _ref3 = [a, b],
                b = _ref3[0],
                a = _ref3[1];
          }

          if (a[_this2.grid_order] > b[_this2.grid_order]) {
            return 1;
          } else if (a[_this2.grid_order] == b[_this2.grid_order]) {
            return 0;
          }
    ...
    setOrder: function setOrder(key) {
    ...
    setFilter: function setFilter(_ref4) {
    ...
    emitCellClick: function () {
      var _emitCellClick = _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime().mark(function _callee2(value, key, row) {
        var emitRow;
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 9:
                ...
                if (this.mode == 'alert') {
                  ...
                  dialog.launch("<div width=500 height=500><".concat(this.$attrs.popup, " :value=\"value\"></").concat(this.$attrs.popup, "></div>"), {
                    data: {
                      value: emitRow
                    },
      ...
      function emitCellClick(_x, _x2, _x3) {
        return _emitCellClick.apply(this, arguments);
      }

      return emitCellClick;
    }(),
    maybeEmitRowClick: function maybeEmitRowClick(row) {
      var _this3 = this;
      ...
      if (!selectedText) {
        this.rowClickTimeout = setTimeout(function () {
...
exports.default = _default;
        var $fdf36f = exports.default || module.exports;
      
      if (typeof $fdf36f === 'function') {
        $fdf36f = $fdf36f.options;
      }
    
        /* template */
        Object.assign($fdf36f, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
      ...
      !_vm.isTable
        ? _c("div", [
            Array.isArray(_vm.data)
              ? _c("div", [
                  _c("pre", {
                    domProps: { textContent: _vm._s(_vm.data.join("\n")) },
                  }),
                ])
        ...
        : _c(
            "table",
            { tag: "div", staticClass: "table" },
            [
              _c(
                "thead",
                {
                  tag: "div",
                  staticStyle: { position: "sticky", top: "-10px" },
                },
                [
                  _c(
                    "tr",
                    ...
                    [
                      _vm._l(_vm.headers, function (h) {
                        return _c(
                          "th",
                          {
                            ...
                            on: {
                              click: function ($event) {
                                return _vm.setOrder(h)
                              },
                            },
                          },
                          [
                            _vm._t("header-" + h, function () {
                              return [
                                _vm._v(
                                  "\n                            " +
                                    _vm._s(h) +
                      ...
                      _vm._v(" "),
                      "actions" in _vm.$attrs || "actions" in _vm.$scopedSlots
                        ? _c("th", { tag: "div" }, [_vm._v(" ")])
                        : _vm._e(),
                    ],
                    2
                  ),
                  _vm._v(" "),
                  _vm.$listeners["filter"] || "filter" in _vm.$attrs
                    ? _c(
                        "tr",
                        { tag: "div" },
                        [
                          _vm._l(_vm.headers, function (h) {
                            return _c(
                              "th",
                              {
                                ...
                                on: {
                                  click: function ($event) {
                                    return _vm.$emit("column-click", h)
                                  },
                                },
                              },
                              [
                          ...
                          _vm._v(" "),
                          "actions" in _vm.$attrs ||
                          "actions" in _vm.$scopedSlots
                            ? _c("th", { tag: "div" }, [_vm._v(" ")])
                            : _vm._e(),
                        ],
                        2
                      ...
                      _c(
                        ...
                        [
                          _c(
                            ...
                            [
                              _c("pre", [_vm._v(_vm._s(_vm.numFilters))]),
                              _vm._v(
              ...
              _c(
                ...
                { tag: "div" },
                [
                  _vm._l(_vm.ordered_data, function (row) {
                    return [
                      _c(
                        "tr",
                        {
                          ...
                          on: {
                            click: function ($event) {
                              return _vm.maybeEmitRowClick(row)
                            },
                          },
                        },
                        [
                            ...
                            return h !== "_id"
                              ? _c(
                                  "td",
                                  {
                                    ...
                                    on: {
                                      click: function ($event) {
                                        return _vm.emitCellClick(row[h], h, row)
                                      },
                                    },
                                  },
                                  [
                      ...
                      _vm._v(" "),
                      _vm.mode == "accordion" && _vm.selectedRow == row
                        ? _c(
                            "tr",
                            { tag: "div" },
                            [
...
render._withStripped = true
          ...
          return {
            ...
            staticRenderFns: staticRenderFns,
            _compiled: true,
            _scopeId: "data-v-fdf36f",
            functional: undefined
          };
        })());
      
},{}],"components/display-object.vue":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
        var $c558b2 = exports.default || module.exports;
      
      if (typeof $c558b2 === 'function') {
        $c558b2 = $c558b2.options;
      }
    
        /* template */
        Object.assign($c558b2, (function () {
          var render = function () {
  var _vm = this
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c(
    ...
    [
      _vm.table
        ? _c("table", { staticClass: "table" }, [
            _c(
              ...
              _vm._l(_vm.data, function (value, name) {
                return _vm.isString(value) || _vm.$scopedSlots[name]
                  ? _c("tr", [
        ...
        : _vm._l(_vm.data, function (value, name) {
            return [
              _vm.isString(value) || _vm.$scopedSlots[name]
                ? _c(
                    "div",
                    [
                      _c("div", [_c("b", [_vm._v(_vm._s(name))])]),
                      _vm._v(" "),
                      _vm._t(
                        name,
                        function () {
...
},{}],"components/pocket-calculator.js":[function(require,module,exports) {
function _toConsumableArray(arr) { return _arrayWithoutHoles(arr) || _iterableToArray(arr) || _unsupportedIterableToArray(arr) || _nonIterableSpread(); }
...
function PocketCalculator(options) {
  ...
  document.addEventListener('keydown', function (event) {
    var isInput = event.target.hasAttribute('data-pocket-calculator') || event.target.matches(options.match);
    var isEqualsSign = event.key == "="; // input[type=number] heeft geen selectionStart.
    // normale input wel.

    var isStartOfInput = (event.target.selectionStart || 0) == 0;
    ...
    if (isInput && isEqualsSign && (isStartOfInput || event.ctrlKey)) {
      ...
      PocketCalculator.launch(_objectSpread(_objectSpread({}, options), {}, {
        value: event.target.value
...
PocketCalculator.launch = function (options) {
  ...
  return dialog.dialog("<div title=\"Pocket Calculator\">\n        <input \n            data-pocket-calculator\n            v-focus \n            v-model=\"value\" \n            @keyup.enter=\"handleEnter\"\n            @keyup.backspace.backspace=\"handleBackspace\"\n            class=\"form-control form-control-lg\"\n\n            ref=\"input\"\n            >\n\n        <template v-if=\"values.length > 0\">\n            <div class=\"mt-2 mb-2 d-flex\">\n\n                <button \n                    class=\"btn btn-sm btn-primary mr-1\"\n                    @click=\"resolve(valuesSum)\"\n                >Sum: {{ valuesSum }}</button>\n                <button \n                    class=\"btn btn-sm btn-primary\"\n                    v-if=\"values.length > 1\" \n                    @click=\"resolve(valuesAvg)\">\n                    Avg: {{ valuesAvg }}\n                </button>\n                <div style=\"flex-grow: 1;\"></div>\n                <button \n                    class=\"btn btn-sm btn-success\"\n                    @click=\"values=[]; $refs.input.focus()\"\n                    >\n                    Reset\n                </button>\n\n            </div>\n\n            <ul>\n                <li v-for=\"v in valuesReverse\">{{v}}</li>\n            </ul>\n        </template>\n    </div>", {
    ...
    computed: {
      valuesReverse: function valuesReverse() {
        return _toConsumableArray(this.values).reverse();
      },
      valuesSum: function valuesSum() {
        return this.values.reduce(function (carry, item) {
          return carry + parseFloat(item);
        }, 0).toFixed(options.precision);
      },
      valuesAvg: function valuesAvg() {
    ...
    methods: {
      ...
      handleEnter: function handleEnter(event) {
        ...
        expression = expression.trim();
        expression = expression // from inc to ex.
        .replace(/\sto\sexc?l?$/, '/' + vatFactor) // amount is ex, so convert to inc.
        .replace(/exc?l?$/, '*' + vatFactor) // from ex to inc 
        .replace(/\sto\sinc?l?$/, '*' + vatFactor) // amount is inc, convert to ex.
      ...
      resolve: function resolve(finalValue) {
...
},{}],"components/vue-debounce.js":[function(require,module,exports) {
function _typeof(obj) { "@babel/helpers - typeof"; return _typeof = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (obj) { return typeof obj; } : function (obj) { return obj && "function" == typeof Symbol && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }, _typeof(obj); }
...
Vue.prototype.debounce = function () {
  var timeout = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 333;
  ...
  if (fn) {
    ...
    return new Promise(function (resolve) {
      component.debounceTimeouts[fnId] = setTimeout(
      /*#__PURE__*/
      _asyncToGenerator(
      /*#__PURE__*/
      _regeneratorRuntime().mark(function _callee() {
    ...
    get: function get(obj, variable) {
      return function () {
        ...
        return new Promise(function (resolve) {
          ...
          component.debounceTimeouts[variable] = setTimeout(
          /*#__PURE__*/
          _asyncToGenerator(
          /*#__PURE__*/
          _regeneratorRuntime().mark(function _callee2() {
            ...
            return _regeneratorRuntime().wrap(function _callee2$(_context2) {
              while (1) {
                switch (_context2.prev = _context2.next) {
                  case 0:
                    _context2.next = 2;
                    return component[variable].apply(component, args);
...
},{}],"vue-harness.js":[function(require,module,exports) {
"use strict";
...
var _vueBlocks = _interopRequireDefault(require("vue-blocks"));

var _vueRouter = _interopRequireDefault(require("vue-router"));

var _uiSuggest = _interopRequireDefault(require("./components/ui-suggest.vue"));

var _provideSuggestions = _interopRequireDefault(require("./components/provide-suggestions.vue"));

var _debug = _interopRequireDefault(require("./components/debug.vue"));

var _tabbedView = _interopRequireDefault(require("./components/tabbed-view.vue"));

var _uiToggle = _interopRequireDefault(require("./components/ui-toggle.vue"));

var _displayTable = _interopRequireDefault(require("./components/display-table.vue"));

var _displayObject = _interopRequireDefault(require("./components/display-object.vue"));
...
window.Vue = _vueCommon.default; // Turn of that warning

_vueCommon.default.config.productionTip = false;
window.VueBlocks = _vueBlocks.default; // Font awesome is still problematic with its fonts not being loaded..
...
_vueCommon.default.directive('tab', function (el) {
  el.addEventListener('keydown', function (event) {
    return insertTab(el, event);
  });
}); // @endsnippet
...
_vueCommon.default.prototype.link = function link(key) {
  var _this = this;
  ...
  var linkToStorage = function linkToStorage(storage, storageKey) {
    ...
    var fullStorageKey = [APP_NAME || _this.$options._componentTag, storageKey].filter(Boolean).join('.'); // console.log("Read " + storageKey);

    if (storage[fullStorageKey]) {
      try {
        var storedData = JSON.parse(storage[fullStorageKey] || 'null'); // De nieuwe manier:
        // console.log('Stored data is ', storedData);

        if ('$$$value$$$' in storedData) {
          _this.$set(_this, key, storedData['$$$value$$$']); // console.log("Sets " + key + " to " + storageKey, storedData['$$$value$$$']);
    ...
    var writeValueToStorage = function writeValueToStorage() {
      storage[fullStorageKey] = JSON.stringify({
        '$$$value$$$': _this[key]
      });
    };
    ...
    var unwatcher = _this.$watch(key, function () {
    ...
    _this.__linksToStorage[key] = {
      ...
      unlink: function unlink() {
        ...
        setTimeout(function () {
          _this.__linksToStorage[key].restore = function () {
    ...
    return _this.__linksToStorage[key];
  };
  ...
  return {
    ...
    restore: function restore() {
      if (!_this.__linksToStorage[key].restore) {
        throw new Error('There is no link to restore for ' + key);
      }

      _this.__linksToStorage[key].restore();
    },
    unlink: function unlink() {
      try {
        _this.__linksToStorage[key].unlink();
      } catch (ignore) {}
    },
    forget: function forget() {
      try {
        _this.__linksToStorage[key].forget();
      } catch (ignore) {}
    }
  };
}; // @endsnippet
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            p = event.target; // When there are no autoSaveHandlers
            // Ensure the last value gets saved properly.

            p.dispatchEvent(new Event('change')); // and wait a bit to let that settle before we trigger the submit event.
          ...
          case 8:
            if (!autoSaveHandlers.length && event.target === document.body) {
              //   console.log("DOE DIT");
              forms = document.querySelectorAll('form'); //   console.log("DIT ZIJN DE FORMS", forms);
          ...
          case 9:
            ...
            return _context.abrupt("return", p.autoSave(event));
          ...
          case 16:
            submit = _toConsumableArray(p.form.querySelectorAll('[type=submit]')).filter(function (s) {
...
_vueCommon.default.directive('ctrl-s', {
  bind: function bind(el, attrs) {
    ...
    autoSaveHandlers.push(function () {
      attrs.value();
    });
  },
...
function popupError(error) {
  ...
  window.dialog.dialog({
    ...
    component: {
      ...
      methods: {
        recoverStringData: function recoverStringData(stringData) {
          try {
...
_vueCommon.default.directive('autoheight', function (el) {
  el.wrap = 'off';
  ...
  var resizeFnDebounce = function resizeFnDebounce() {
    clearTimeout(timeout);
...
function debounce(timeout, name) {
  ...
  return new Promise(function (resolve, reject) {
    ...
    debounce.timeouts[name] = function () {
      clearTimeout(tm);
      reject();
    };
  });
...
_vueCommon.default.prototype.alert = window.alert.bind(window);
/* @endsnippet */

/* @snippet fc7904-60d727-743469-1029a6-loader */

_vueCommon.default.component('ui-suggest', _uiSuggest.default);

_vueCommon.default.component('provide-suggestions', _provideSuggestions.default);
/* @endsnippet */
...
window.axios.interceptors.response.use(function (response) {
  if (response.headers['xsrf-token']) {
    _axios.default.defaults.headers.common['xsrf-token'] = response.headers['xsrf-token'];
  }

  return response;
}, function (error) {
  if (error && error.response && error.response.headers['xsrf-token']) {
    _axios.default.defaults.headers.common['xsrf-token'] = error.response.headers['xsrf-token'];
  }
});
/* @endsnippet */
...
_vueCommon.default.directive('focus', {
...
_vueCommon.default.directive('focus-first', {
  inserted: function inserted(el) {
    setTimeout(function () {
      try {
...
_vueCommon.default.prototype.api = window.api;
...
if (!mountAttr || mountAttr == 'true') {
  var startApp = function startApp() {
    ...
    _vueCommon.default.use(_vueBlocks.default);

    _vueCommon.default.use(_vueRouter.default);

    var app = new _vueCommon.default(_objectSpread({
      el: "app",
      router: new _vueRouter.default({
        routes: _vueBlocks.default.collectRoutes()
      })
...
window.strtotime = require('locutus/php/datetime/strtotime'); // @snippet javascript/peri-dates

window.peri = {
  make: function make(period) {
   ...
   */
  extract: function extract(period, type) {
  ...
  interval: function interval(period) {
    var returnClosedInterval = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    return function (period) {
      var match;

      if (period.match(/^[0-9]{4}$/)) {
        return ["".concat(period, "-01-01"), returnClosedInterval ? "".concat(period, "-12-31") : "".concat(period + 1, "-01-01")];
      }
      ...
      switch (type.toUpperCase()) {
        case 'Q':
          ts = strtotime("".concat(year, "-").concat(pad(period * 3 - 2), "-01"));
          tse = strtotime('+3 months', ts);
          break;

        case 'M':
          ts = strtotime(_ = "".concat(year, "-").concat(pad(period), "-01"));
          tse = strtotime('+1 month', ts);
          break;

        case 'W':
          var first_monday = strtotime('last monday', strtotime("".concat(year, "-01-07")));
          var first_week = date('W', first_monday);
          var delta = periodInt - parseInt(first_week);
          ts = strtotime("+".concat(delta * 7, " days"), first_monday);
   ...
   * @param {*} to_period 
   */
  enum: function _enum(period, to_period) {
    var chunkSizes = {
      'year': '+1 year',
      'quarter': '+3 months',
      'month': '+1 month',
    ...
    if (Array.isArray(period)) {
      var _period$map = period.map(strtotime),
          _period$map2 = _slicedToArray(_period$map, 2),
          ts = _period$map2[0],
          tse = _period$map2[1];
    } else {
      var _peri$interval$map = peri.interval(period).map(strtotime),
          _peri$interval$map2 = _slicedToArray(_peri$interval$map, 2),
          ts = _peri$interval$map2[0],
          tse = _peri$interval$map2[1];
    }
...
_vueCommon.default.directive('fullheight', {
  bind: function bind(el) {
    ...
    var FULLHEIGHT_OFFSET = window.FULLHEIGHT_OFFSET || 0;
    var timeout;
...
_vueCommon.default.component('debug', _debug.default);

_vueCommon.default.component('tabbed-view', _tabbedView.default);

_vueCommon.default.component('ui-toggle', _uiToggle.default);

_vueCommon.default.component('display-table', _displayTable.default);

_vueCommon.default.component('display-object', _displayObject.default);

require('./components/pocket-calculator.js');

window.componentExists = _vueCommon.default.prototype.componentExists = function (component) {
  return _vueCommon.default.options.components[component] || false;
};

function isScalar(mixedVar) {
  // @fixme - moeten we `null` ook als scalar beschouwen?
  return /boolean|number|string/.test(_typeof(mixedVar));
}

window.isScalar = isScalar;
_vueCommon.default.prototype.isScalar = isScalar; // shortcuts for json stringify and parse.
...
function json() {
  ...
  if (args.length == 1) {
    args = [].concat(_toConsumableArray(args), [null, 3]);
  }

  return JSON.stringify.apply(JSON, _toConsumableArray(args));
}

json.parse = JSON.parse.bind(JSON);
window.json = json;
_vueCommon.default.prototype.json = json;

require('./components/vue-debounce');
},{"regenerator-runtime/runtime":"node_modules/regenerator-runtime/runtime.js","axios":"node_modules/axios/index.js","bootstrap/dist/css/bootstrap.min.css":"node_modules/bootstrap/dist/css/bootstrap.min.css","font-awesome/css/font-awesome.css":"node_modules/font-awesome/css/font-awesome.css","vue/dist/vue.common.dev":"node_modules/vue/dist/vue.common.dev.js","vue-blocks":"node_modules/vue-blocks/index.js","vue-router":"node_modules/vue-router/dist/vue-router.esm.js","./components/ui-suggest.vue":"components/ui-suggest.vue","./components/provide-suggestions.vue":"components/provide-suggestions.vue","./components/toast/index":"components/toast/index.js","./components/toast/toast.css":"node_modules/bootstrap/dist/css/bootstrap.min.css","./components/dialog/index":"components/dialog/index.js","./components/dialog/dialog.css":"node_modules/bootstrap/dist/css/bootstrap.min.css","locutus/php/datetime/date":"node_modules/locutus/php/datetime/date.js","locutus/php/datetime/strtotime":"node_modules/locutus/php/datetime/strtotime.js","./components/debug.vue":"components/debug.vue","./components/tabbed-view.vue":"components/tabbed-view.vue","./components/ui-toggle.vue":"components/ui-toggle.vue","./components/display-table.vue":"components/display-table.vue","./components/display-object.vue":"components/display-object.vue","./components/pocket-calculator.js":"components/pocket-calculator.js","./components/vue-debounce":"components/vue-debounce.js"}]},{},["vue-harness.js"], null)