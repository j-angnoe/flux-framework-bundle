...
class Vue3BlocksLayout implements LayoutInterface {
    /**
    ...
    #[Route("/assets/_vue3-harness/dist/{filename}", stateless: true)]
    function serve_dist(string $filename): BinaryFileResponse { 
        $path = static::getLayersDir() . '/vue3-harness/dist/' . $filename;
